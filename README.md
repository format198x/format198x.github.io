# format198x.github.io

The Format198x site. A skeleton: a wordmark, a sentence, and the shared kit
wired up — so the name has somewhere to point and the identity is applied from
the start rather than retrofitted.

Live. A format graduates here from the project that first needed it, once it has a standalone consumer.
